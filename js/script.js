...
Происходит делегирование событий: мы задали обработчик событий на все тело документа и еще 1 обработчик на список, котрый сам находится в теле документа.
При нажатии на кнопку из списка ul происходит всплытие: сначала происходит событие ul, а потом событие тела документа
*/
